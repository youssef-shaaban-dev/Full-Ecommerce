            ...
            {isLoggedIn ? (
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button variant="ghost" className="flex items-center gap-2 text-gray-700 hover:text-red-600 hover:bg-red-50 transition-all duration-300 px-2 font-Inter">
                    ...
                    <DropdownMenuContent align={locale === "ar" ? "end" : "start"} className="w-56">
                        ...
                        <DropdownMenuItem className="hover:bg-red-50 focus:bg-red-50 cursor-pointer flex items-center">
                        ...
                        <Separator />
                        <DropdownMenuItem
                            className="hover:bg-red-50 focus:bg-red-50 cursor-pointer text-red-600 flex items-center"
                            onClick={logout}
                        >
                            <svg className="h-4 w-4 me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
